...
flags.DEFINE_string(
    "output_file", './data/news.tf_recorder',
...
def create_instances_from_document_albert(
  ...
  while i < len(document): # 从文档的第一个位置开始，按个往下看
    ...
    if FLAGS.non_chinese is False and False: # if non chinese is False, that means it is chinese, then do something to make chinese whole word mask works.
