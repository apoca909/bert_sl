...
#https://github.com/phipleg/keras.git
#crf branch
...
def sparse_chain_crf_loss(y_true, y_pred, U, b_start=None, b_end=None, mask=None):
    ...
    '''
    y_pred = add_boundary_energy(y_pred, b_start, b_end, mask)
    energy = path_energy0(y_true, y_pred, U, mask)
    energy -= free_energy0(y_pred, U, mask)
