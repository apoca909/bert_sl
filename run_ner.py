...
flags.DEFINE_string(
    "bert_config_file", './bert_model/albert_config_tiny.json',
...
flags.DEFINE_string(
    "output_dir", './bert_model_ner/',
    "The output directory where the model checkpoints will be written.")

## Other parameters

flags.DEFINE_string(
    "init_checkpoint", './bert_model/albert_model.ckpt',
...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        :return:
        """
        return ["[PAD]", "B-WD", "I-WD", "E-WD", "S-WD", "[CLS]",  "[SEP]"]
